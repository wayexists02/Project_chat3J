...
import com.chat3j.core.client.commands.CommunicationInputCommand;
import com.chat3j.core.client.commands.DisconnectBetweenClientCommand;
import com.chat3j.core.client.commands.PublisherCommand;
    ...
    class ConnectionListener extends Listener {
        ...
        public void received(Connection conn, Object obj) {
            if (obj instanceof VoiceDataMsg) {
                ...
                System.out.println("Voice Data Msg is Received - size : " + msg.size + " / HashCode : "+msg.data.hashCode());
