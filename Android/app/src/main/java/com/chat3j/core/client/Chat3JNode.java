...
import com.chat3j.core.client.commands.CloseCommand;
import com.chat3j.core.client.commands.Command;
import com.chat3j.core.client.commands.ConnectToNewCommand;
import com.chat3j.core.client.commands.CreateTopicCommand;
import com.chat3j.core.client.commands.RequestTopicCommand;
import com.chat3j.core.client.commands.TopicListCommand;
import com.chat3j.core.messages.DisconnectToServerMsg;
...
public class Chat3JNode {
    ...
    public void connectTo(String topic, final String addr, final int tcp, final int udp) {
        final Publisher pub = publishers.get(topic);
        new Thread(){
            @Override
            public void run() {
